        ...
        var Rive = (() => {
          ...
          return function (moduleArg = {}) {
                ...
                this.Qb = function (k, t, r, A, D) {
                  if (a()) {
                    ...
                    if (b.canvas) {
                      ...
                      w = v.push(A);
                      g != w &&
                        (b.bufferData(b.ARRAY_BUFFER, 8 * w, b.DYNAMIC_DRAW),
                        (g = w));
                      w = 0;
                      for (var T of r) {
                        b.bufferSubData(b.ARRAY_BUFFER, w, T.Ta),
                          (w += 4 * T.Ta.length);
                      }
                      console.assert(w == 4 * A);
                      for (var ca of r) {
                        b.bufferSubData(b.ARRAY_BUFFER, w, ca.Db),
                          (w += 4 * ca.Db.length);
                      }
                      ...
                      T = 0;
                      for (var ra of r) {
                        b.bufferSubData(b.ELEMENT_ARRAY_BUFFER, T, ra.indices),
                          (T += 2 * ra.indices.length);
                      }
                      ...
                      for (const F of r) {
                        F.image.Ka != ra &&
                          (b.bindTexture(b.TEXTURE_2D, F.image.Ja || null),
                          (ra = F.image.Ka));
                        F.mc
                          ? (b.scissor(F.Ya, M - F.Za - F.jb, F.Ac, F.jb),
                            (ca = !0))
                          : ca && (b.scissor(0, M - t, k, t), (ca = !1));
                        r = 2 / k;
                        const ba = -2 / t;
                        b.uniform4f(
                          e,
                        ...
                        b.uniform2f(
                          f,
                          F.ha[4] * r * F.Ba + r * (F.Ya - F.ic * F.Ba) - 1,
                          F.ha[5] * ba * F.Ca + ba * (F.Za - F.jc * F.Ca) + 1
                        );
            ...
            m.onRuntimeInitialized = function () {
              ...
              function c() {
                0 < M.length &&
                  (ka.Qb(w.drawWidth(), w.drawHeight(), M, T, ca),
                  (M = []),
                  (ca = T = 0),
                  w.reset(512, 512));
                for (const q of D) {
                  ...
                  draw: function (q, z, G) {
                    ...
                    if (null != I) {
                      ...
                      I.ec
                        ...
                        : (C = q.createLinearGradient(C, J, X, K));
            ...
            if (oa || pa) {
              pa
                ...
                : "undefined" != typeof document &&
                  ...
                  (qa = document.currentScript.src),
                _scriptDir && (qa = _scriptDir),
                0 !== qa.indexOf("blob:")
                  ? (qa = qa.substr(
                      0,
                      qa.replace(/[?#].*/, "").lastIndexOf("/") + 1
                    ))
                  : (qa = ""),
                pa &&
                  (va = (a) => {
            ...
            "object" != typeof WebAssembly &&
              Aa("no native wasm support detected");
            var Ba,
              y,
              Ca = !1,
              B,
            ...
            var Za,
              ...
              db = {
                ...
                432821: (a, b, c, d, e, f) => {
                  ...
                  g.Z.onaudioprocess = function (p) {
                    ...
                    if (a == window.h.H.capture || a == window.h.H.La) {
                      for (var l = 0; l < b; l += 1) {
                        for (
                          var u = p.inputBuffer.getChannelData(l),
                            v = g.sa,
                            x = 0;
                          x < d;
                          x += 1
                    ...
                    if (a == window.h.H.ya || a == window.h.H.La) {
                      for (
                        cb(f, d, e), l = 0;
                        l < p.outputBuffer.numberOfChannels;
                        ++l
                      ) {
                        for (
                          u = p.outputBuffer.getChannelData(l), v = g.sa, x = 0;
                          x < d;
                          x += 1
                        ) {
                          u[x] = v[x * b + l];
                  ...
                  (a != window.h.H.capture && a != window.h.H.La) ||
                ...
                435698: (a) => window.h.ra(a).I.sampleRate,
                435771: (a) => {
                  a = window.h.ra(a);
                  void 0 !== a.Z &&
            ...
            function yb(a, b) {
              ...
              c >= b ||
                ((b = Math.max(b, (c * (1048576 > c ? 2.0 : 1.125)) >>> 0)),
              ...
              createNode(a, b, c, d) {
                ...
                P.O ||
                  (P.O = {
                    ...
                    link: {
                      node: { Y: P.l.Y, P: P.l.P, ma: P.l.ma },
                      stream: {},
                    },
                    $a: { node: { Y: P.l.Y, P: P.l.P }, stream: zb },
                  });
                c = Ab(a, b, c, d);
                16384 === (c.mode & 61440)
                  ? ((c.l = P.O.dir.node), (c.m = P.O.dir.stream), (c.j = {}))
                  : 32768 === (c.mode & 61440)
                  ? ((c.l = P.O.file.node),
                    (c.m = P.O.file.stream),
                    (c.v = 0),
                    (c.j = null))
                  : 40960 === (c.mode & 61440)
                  ? ((c.l = P.O.link.node), (c.m = P.O.link.stream))
                  : 8192 === (c.mode & 61440) &&
                    ((c.l = P.O.$a.node), (c.m = P.O.$a.stream));
              ...
              ec = (a, b, c) => {
                ...
                if (
                  ...
                  (c = e
                    ? 40960 === (e.mode & 61440)
                      ? 32
                      : 16384 === (e.mode & 61440) && ("r" !== Qb(b) || b & 512)
                      ? 31
                      : Ob(e, Qb(b))
                    : 44)
                ) {
            ...
            function Oc(a, b) {
              ...
              !!b.L !== !!b.G &&
                Nc("Both smartPtrType and smartPtr must be specified");
              b.count = { value: 1 };
            ...
            function Xc(a, b, c = {}) {
              ...
              delete Uc[a];
              Tc.hasOwnProperty(a) &&
                ((b = Tc[a]), delete Tc[a], b.forEach((e) => e()));
            }
            function Vc(a, b, c = {}) {
            ...
            function od(a, b) {
              function c(f) {
                e[f] ||
                  Bc[f] ||
                  (Uc[f] ? Uc[f].forEach(c) : (d.push(f), (e[f] = !0)));
              }
              var d = [],
                e = {};
              b.forEach(c);
            ...
            function pd(a, b, c, d, e) {
              ...
              return function () {
                arguments.length !== l &&
                  V(
                    `function ${a} called with ${arguments.length} arguments, expected ${l} args!`
                  );
                x.length = 0;
                v.length = g ? 2 : 1;
                v[0] = e;
            ...
            var Jd = [],
              ...
              Rd = (a, b, c, d) => {
                ...
                function g(k, t) {
                  ...
                  var A;
                  0 === (A = r(k.getFullYear() - t.getFullYear())) &&
                    0 === (A = r(k.getMonth() - t.getMonth())) &&
                    (A = r(k.getDate() - t.getDate()));
                  return A;
                }
                function n(k) {
                  switch (k.getDay()) {
                ...
                function p(k) {
                  var t = k.ca;
                  for (
                    k = new Date(new Date(k.da + 1900, 0, 1).getTime());
                    0 < t;
                ...
                l = {
                  ...
                  "%w": (k) => k.R,
                  "%W": (k) =>
                    f(Math.floor((k.ca + 7 - ((k.R + 6) % 7)) / 7), 2),
            ...
            Zc.prototype["delete"] = function () {
              ...
              this.g.fa &&
                !this.g.ia &&
                V("Object already scheduled for deletion");
              Gc(this);
              Ic(this.g);
            ...
            hd.prototype.fromWireType = function (a) {
              function b() {
                return this.ua
                  ? Oc(this.i.N, { u: this.nc, o: c, L: this, G: a })
                  : Oc(this.i.N, { u: this, o: a });
              }
              var c = this.Vb(a);
              if (!c) {
            ...
            var Wd = {
              ...
              _embind_create_inheriting_constructor: function (a, b, c) {
                ...
                f.__construct = function () {
                  ...
                  l = Ac(e, l);
                  zc.hasOwnProperty(l)
                    ? V(`Tried to register registered instance: ${l}`)
                    : (zc[l] = this);
                };
                f.__destruct = function () {
                  ...
                  zc.hasOwnProperty(l)
                    ? delete zc[l]
                    : V(`Tried to unregister unregistered instance: ${l}`);
                };
                  ...
                  Y([], n, function (x) {
                    ...
                    if (p.i.oa) {
                      for (const k of p.i.oa) {
                        k.constructor.hasOwnProperty(b) ||
                          (k.constructor[b] = x);
                      }
                    }
                    return [];
              ...
              _embind_register_class_function: function (
                ...
                Y([], [a], function (l) {
                  ...
                  var x = l.i.N,
                    k = x[b];
                  void 0 === k ||
                  (void 0 === k.B && k.className !== l.name && k.ea === c - 2)
                    ? ((u.ea = c - 2), (u.className = l.name), (x[b] = u))
                    : ($c(x, b, v), (x[b].B[c - 2] = u));
                  Y([], p, function (t) {
                    t = pd(v, t, l, f, g);
                    void 0 === x[b].B
              ...
              _embind_register_function: function (a, b, c, d, e, f) {
                ...
                Y([], g, function (n) {
                  jd(
                    a,
                    pd(a, [n[0], null].concat(n.slice(1)), null, e, f),
                    b - 1
                  );
                  return [];
                });
              ...
              _embind_register_std_wstring: function (a, b, c) {
                ...
                if (2 === b) {
                  ...
                  4 === b &&
                    ((d = Bd), (e = Cd), (f = Dd), (g = () => N), (n = 2));
                }
                Vc(a, {
                  name: c,
                  fromWireType: function (p) {
                    for (
                      var l = N[p >> 2], u = g(), v, x = p + 4, k = 0;
                      k <= l;
                      ++k
                    ) {
                      var t = p + 4 + k * b;
              ...
              _emval_get_method_caller: function (a, b) {
                ...
                e = Hd((g, n, p, l) => {
                  for (var u = 0, v = 0; v < a - 1; ++v) {
                    (f[v] = c[v + 1].readValueFromPointer(l + u)),
                      (u += c[v + 1].argPackAdvance);
                  }
                  g = g[n].apply(g, f);
                  for (v = 0; v < a - 1; ++v) {
              ...
              fd_seek: function (a, b, c, d, e) {
                ...
                try {
                  ...
                  $a = [
                    ...
                    1.0 <= +Math.abs(Za)
                      ? 0.0 < Za
                        ? +Math.floor(Za / 4294967296.0) >>> 0
                        : ~~+Math.ceil((Za - +(~~Za >>> 0)) / 4294967296.0) >>>
                          0
                      : 0),
                  ];
                  L[e >> 2] = $a[0];
            ...
            (function () {
              function a(c) {
                ...
                if (
                  0 == Pa &&
                  (null !== Qa && (clearInterval(Qa), (Qa = null)), Ra)
                ) {
                  var d = Ra;
                  Ra = null;
                  d();
            ...
            var Ec = (a) => (Ec = y.free)(a),
              Vd = (a) => (Vd = y.malloc)(a),
              ab = (m._ma_device__on_notification_unlocked = (a) =>
                (ab = m._ma_device__on_notification_unlocked =
                  y.ma_device__on_notification_unlocked)(a));
            m._ma_malloc_emscripten = (a, b) =>
              (m._ma_malloc_emscripten = y.ma_malloc_emscripten)(a, b);
            m._ma_free_emscripten = (a, b) =>
              (m._ma_free_emscripten = y.ma_free_emscripten)(a, b);
            var bb = (m._ma_device_process_pcm_frames_capture__webaudio = (
                a,
                b,
                c
              ) =>
                (bb = m._ma_device_process_pcm_frames_capture__webaudio =
                  y.ma_device_process_pcm_frames_capture__webaudio)(a, b, c)),
              cb = (m._ma_device_process_pcm_frames_playback__webaudio = (
                a,
                b,
                c
              ) =>
                (cb = m._ma_device_process_pcm_frames_playback__webaudio =
                  y.ma_device_process_pcm_frames_playback__webaudio)(a, b, c)),
              Ud = () => (Ud = y.__errno_location)(),
              Dc = (a) => (Dc = y.__getTypeName)(a);
            m.__embind_initialize_bindings = () =>
              (m.__embind_initialize_bindings =
                y._embind_initialize_bindings)();
            m.dynCall_iiji = (a, b, c, d, e) =>
              (m.dynCall_iiji = y.dynCall_iiji)(a, b, c, d, e);
            m.dynCall_jiji = (a, b, c, d, e) =>
              (m.dynCall_jiji = y.dynCall_jiji)(a, b, c, d, e);
            m.dynCall_iiiji = (a, b, c, d, e, f) =>
              (m.dynCall_iiiji = y.dynCall_iiiji)(a, b, c, d, e, f);
            m.dynCall_iij = (a, b, c, d) =>
              (m.dynCall_iij = y.dynCall_iij)(a, b, c, d);
            m.dynCall_jii = (a, b, c) =>
              (m.dynCall_jii = y.dynCall_jii)(a, b, c);
            m.dynCall_viijii = (a, b, c, d, e, f, g) =>
              (m.dynCall_viijii = y.dynCall_viijii)(a, b, c, d, e, f, g);
            m.dynCall_iiiiij = (a, b, c, d, e, f, g) =>
              (m.dynCall_iiiiij = y.dynCall_iiiiij)(a, b, c, d, e, f, g);
            m.dynCall_iiiiijj = (a, b, c, d, e, f, g, n, p) =>
              (m.dynCall_iiiiijj = y.dynCall_iiiiijj)(
                a,
                b,
                c,
                d,
            ...
            m.dynCall_iiiiiijj = (a, b, c, d, e, f, g, n, p, l) =>
              (m.dynCall_iiiiiijj = y.dynCall_iiiiiijj)(
                a,
                b,
                c,
                d,
              ...
              function a() {
                if (!Xd && ((Xd = !0), (m.calledRun = !0), !Ca)) {
                  m.noFSInit ||
                    ...
                    m.stdin
                      ? jc("stdin", m.stdin)
                      : cc("/dev/tty", "/dev/stdin"),
                    m.stdout
                      ? jc("stdout", null, m.stdout)
                      : cc("/dev/tty", "/dev/stdout"),
                    m.stderr
                      ? jc("stderr", null, m.stderr)
                      : cc("/dev/tty1", "/dev/stderr"),
                    ec("/dev/stdin", 0),
                    ec("/dev/stdout", 1),
                    ec("/dev/stderr", 1));
                  Jb = !1;
              ...
              switch (_b.label) {
                ...
                case 2:
                  ...
                  this.eventManager.fire({
                    type: EventType.Load,
                    data:
                      (_a = this.src) !== null && _a !== void 0 ? _a : "buffer",
                  });
